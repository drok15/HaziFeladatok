...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView eredmeny2 = findViewById(R.id.eredmeny2);
        final TextView eredmeny3 = findViewById(R.id.eredmeny3);
        final TextView eredmeny4 = findViewById(R.id.eredmeny4);
